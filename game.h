...
class Game {
	public:
		...
		void RotateTetromino(); // try rotating the tetromino. If the rotation would collide with something, do nothing.
		...
		// TODO: make these private variables as needed. These are currently required to display on-screen.

		// The game board. Each position is either free (false) or filled (true).
		//
